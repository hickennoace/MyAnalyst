// Canonical "not financial / investment advice" text, kept in lib so both UI components and
// analysis modules (e.g. the methodology appendix) share one source of truth.
