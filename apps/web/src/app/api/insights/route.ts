...
function buildAnswerPrompt(
  ...
  const system = [
    ...
    "• facts — question-specific numbers (group breakdowns with shares, trends, distributions, the cited correlation, and for an 'X vs Y' question a `comparison` block with each side's value, the gap, % difference, ratio, and which side is higher).",
