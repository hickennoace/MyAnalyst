...
> (`skills/animation/framer-motion/SKILL.md`). Reference only — no executable steps.
...
- `motion` components use hooks/context → only usable in Client Components. Put animated UI in a
